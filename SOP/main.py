...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/tdmatch/tdmatch.yaml', help='Path to config file.')  # kitti/kitti.yaml /tdmatch/tdmatch_test.yaml
    ...
    #     benchmark_set = get_dataset(config)
