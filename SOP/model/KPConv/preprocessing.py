...
def collate_fn_descriptor(list_data, config, neighborhood_limits):
    ...
    for ind, (src_pcd, tgt_pcd, src_feats, tgt_feats, rot, trans, matching_inds, src_pcd_raw, tgt_pcd_raw, sample,
              src_overlap, tgt_overlap) in enumerate(list_data):
    ...
    dict_inputs = {
        ...
        'node_corr': node_corr,
        'src_overlap': torch.from_numpy(src_overlap),
        'tgt_overlap': torch.from_numpy(tgt_overlap),
