...
from dataset.common import compute_overlap_and_correspondences
...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Get matches
        src_overlap, tgt_overlap, matching_inds = compute_overlap_and_correspondences(pcd0, pcd1, tsfm, self.matching_search_voxel_size)
